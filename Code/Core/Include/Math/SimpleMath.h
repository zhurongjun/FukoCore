...
namespace Fuko
{
    ...
    struct Color : public XMFLOAT4
    {
        ...
        explicit Color(const Fuko::PackedVector::XMCOLOR& Packed) noexcept;
            // BGRA Direct3D 9 D3DCOLOR packed color

        explicit Color(const Fuko::PackedVector::XMUBYTEN4& Packed) noexcept;
        ...
        Color& operator= (const Fuko::PackedVector::XMCOLOR& Packed) noexcept;
        Color& operator= (const Fuko::PackedVector::XMUBYTEN4& Packed) noexcept;
        ...
        // Color operations
        Fuko::PackedVector::XMCOLOR BGRA() const noexcept;
        Fuko::PackedVector::XMUBYTEN4 RGBA() const noexcept;
	...
	struct Box
	{
		...
		Box() = default;
		Box(T InLeft, T InRight, T InTop, T InBottom, T InFront, T InBack)
			: Left(InLeft)
			, Right(InRight)
			, Top(InTop)
			, Bottom(InBottom)
...
namespace std
{
    ...
    template<> struct less<Fuko::Rectangle>
    {
        bool operator()(const Fuko::Rectangle& r1, const Fuko::Rectangle& r2) const noexcept
        {
            return ((r1.x < r2.x)
                    || ((r1.x == r2.x) && (r1.y < r2.y))
    ...
    template<> struct less<Fuko::Vector2>
    {
        bool operator()(const Fuko::Vector2& V1, const Fuko::Vector2& V2) const noexcept
        {
            return ((V1.x < V2.x) || ((V1.x == V2.x) && (V1.y < V2.y)));
        }
    };
						   
    template<> struct less<Fuko::Vector3>
    {
        bool operator()(const Fuko::Vector3& V1, const Fuko::Vector3& V2) const noexcept
        {
            return ((V1.x < V2.x)
                    || ((V1.x == V2.x) && (V1.y < V2.y))
    ...
    template<> struct less<Fuko::Vector4>
    {
        bool operator()(const Fuko::Vector4& V1, const Fuko::Vector4& V2) const noexcept
        {
            return ((V1.x < V2.x)
                    || ((V1.x == V2.x) && (V1.y < V2.y))
                    || ((V1.x == V2.x) && (V1.y == V2.y) && (V1.z < V2.z))
    ...
    template<> struct less<Fuko::Matrix>
    {
        bool operator()(const Fuko::Matrix& M1, const Fuko::Matrix& M2) const noexcept
        {
    ...
    template<> struct less<Fuko::Plane>
    {
        bool operator()(const Fuko::Plane& P1, const Fuko::Plane& P2) const noexcept
        {
            return ((P1.x < P2.x)
                    || ((P1.x == P2.x) && (P1.y < P2.y))
    ...
    template<> struct less<Fuko::Quaternion>
    {
        bool operator()(const Fuko::Quaternion& Q1, const Fuko::Quaternion& Q2) const noexcept
        {
            return ((Q1.x < Q2.x)
                    || ((Q1.x == Q2.x) && (Q1.y < Q2.y))
    ...
    template<> struct less<Fuko::Color>
    {
        bool operator()(const Fuko::Color& C1, const Fuko::Color& C2) const noexcept
        {
            return ((C1.x < C2.x)
                    || ((C1.x == C2.x) && (C1.y < C2.y))
    ...
    template<> struct less<Fuko::Ray>
    {
        bool operator()(const Fuko::Ray& R1, const Fuko::Ray& R2) const noexcept
        {
    ...
    template<> struct less<Fuko::Viewport>
    {
        bool operator()(const Fuko::Viewport& vp1, const Fuko::Viewport& vp2) const noexcept
        {
