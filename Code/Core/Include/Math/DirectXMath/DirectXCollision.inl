...
namespace Internal
{
    ...
    {
        *pV1 = Fuko::Internal::CalculateEigenVector(m11, m12, m13, m22, m23, m33, e1);
        *pV2 = Fuko::Internal::CalculateEigenVector(m11, m12, m13, m22, m23, m33, e2);
        *pV3 = Fuko::Internal::CalculateEigenVector(m11, m12, m13, m22, m23, m33, e3);
        ...
        _Out_ XMVECTOR* pV1, _Out_ XMVECTOR* pV2, _Out_ XMVECTOR* pV3) noexcept
    {
        ...
        float ev1, ev2, ev3;
        if (!Fuko::Internal::SolveCubic(e, f, g, &ev1, &ev2, &ev3))
        {
        ...
        return Fuko::Internal::CalculateEigenVectors(Cxx, Cxy, Cxz, Cyy, Cyz, Czz, ev1, ev2, ev3, pV1, pV2, pV3);
    }
...
inline ContainmentType BoundingSphere::Contains(const BoundingOrientedBox& box) const noexcept
{
    ...
    assert(Fuko::Internal::XMQuaternionIsUnit(boxOrientation));
...
inline ContainmentType BoundingSphere::Contains(const BoundingFrustum& fr) const noexcept
{
    ...
    assert(Fuko::Internal::XMQuaternionIsUnit(vOrientation));
...
inline bool XM_CALLCONV BoundingSphere::Intersects(FXMVECTOR V0, FXMVECTOR V1, FXMVECTOR V2) const noexcept
{
    ...
    XMVECTOR Intersection = Fuko::Internal::PointOnPlaneInsideTriangle(Point, V0, V1, V2);

    // Find the nearest point on each edge.
    XMVECTOR RadiusSq = XMVectorMultiply(vRadius, vRadius);

    // Edge 0,1
    Point = Fuko::Internal::PointOnLineSegmentNearestPoint(V0, V1, vCenter);
    ...
    // Edge 1,2
    Point = Fuko::Internal::PointOnLineSegmentNearestPoint(V1, V2, vCenter);
    ...
    // Edge 2,0
    Point = Fuko::Internal::PointOnLineSegmentNearestPoint(V2, V0, vCenter);
...
{
    assert(Fuko::Internal::XMPlaneIsUnit(Plane));
    ...
    Fuko::Internal::FastIntersectSpherePlane(vCenter, vRadius, Plane, Outside, Inside);
...
{
    assert(Fuko::Internal::XMVector3IsUnit(Direction));
    ...
    HXMVECTOR Plane4, HXMVECTOR Plane5) const noexcept
{
    ...
    Fuko::Internal::FastIntersectSpherePlane(vCenter, vRadius, Plane0, Outside, Inside);

    XMVECTOR AnyOutside = Outside;
    XMVECTOR AllInside = Inside;

    Fuko::Internal::FastIntersectSpherePlane(vCenter, vRadius, Plane1, Outside, Inside);
    AnyOutside = XMVectorOrInt(AnyOutside, Outside);
    AllInside = XMVectorAndInt(AllInside, Inside);

    Fuko::Internal::FastIntersectSpherePlane(vCenter, vRadius, Plane2, Outside, Inside);
    AnyOutside = XMVectorOrInt(AnyOutside, Outside);
    AllInside = XMVectorAndInt(AllInside, Inside);

    Fuko::Internal::FastIntersectSpherePlane(vCenter, vRadius, Plane3, Outside, Inside);
    AnyOutside = XMVectorOrInt(AnyOutside, Outside);
    AllInside = XMVectorAndInt(AllInside, Inside);

    Fuko::Internal::FastIntersectSpherePlane(vCenter, vRadius, Plane4, Outside, Inside);
    AnyOutside = XMVectorOrInt(AnyOutside, Outside);
    AllInside = XMVectorAndInt(AllInside, Inside);

    Fuko::Internal::FastIntersectSpherePlane(vCenter, vRadius, Plane5, Outside, Inside);
    AnyOutside = XMVectorOrInt(AnyOutside, Outside);
    AllInside = XMVectorAndInt(AllInside, Inside);
...
{
    assert(Fuko::Internal::XMQuaternionIsUnit(Rotation));
...
inline ContainmentType BoundingBox::Contains(const BoundingBox& box) const noexcept
{
    ...
    if (Fuko::Internal::XMVector3AnyTrue(Disjoint))
        return DISJOINT;
    ...
    return Fuko::Internal::XMVector3AllTrue(Inside) ? CONTAINS : INTERSECTS;
}
...
inline ContainmentType BoundingBox::Contains(const BoundingOrientedBox& box) const noexcept
{
    ...
    assert(Fuko::Internal::XMQuaternionIsUnit(oOrientation));
...
inline bool BoundingBox::Intersects(const BoundingBox& box) const noexcept
{
    ...
    return !Fuko::Internal::XMVector3AnyTrue(Disjoint);
}
...
inline PlaneIntersectionType XM_CALLCONV BoundingBox::Intersects(FXMVECTOR Plane) const noexcept
{
    ...
    XMVECTOR Outside, Inside;
    Fuko::Internal::FastIntersectAxisAlignedBoxPlane(vCenter, vExtents, Plane, Outside, Inside);
...
inline bool XM_CALLCONV BoundingBox::Intersects(FXMVECTOR Origin, FXMVECTOR Direction, float& Dist) const noexcept
{
    ...
    if (!Fuko::Internal::XMVector3AnyTrue(NoIntersection))
    {
        // Store the x-component to *pDist
    ...
    HXMVECTOR Plane4, HXMVECTOR Plane5) const noexcept
{
    ...
    // Test against each plane.
    Fuko::Internal::FastIntersectAxisAlignedBoxPlane(vCenter, vExtents, Plane0, Outside, Inside);

    XMVECTOR AnyOutside = Outside;
    XMVECTOR AllInside = Inside;

    Fuko::Internal::FastIntersectAxisAlignedBoxPlane(vCenter, vExtents, Plane1, Outside, Inside);
    AnyOutside = XMVectorOrInt(AnyOutside, Outside);
    AllInside = XMVectorAndInt(AllInside, Inside);

    Fuko::Internal::FastIntersectAxisAlignedBoxPlane(vCenter, vExtents, Plane2, Outside, Inside);
    AnyOutside = XMVectorOrInt(AnyOutside, Outside);
    AllInside = XMVectorAndInt(AllInside, Inside);

    Fuko::Internal::FastIntersectAxisAlignedBoxPlane(vCenter, vExtents, Plane3, Outside, Inside);
    AnyOutside = XMVectorOrInt(AnyOutside, Outside);
    AllInside = XMVectorAndInt(AllInside, Inside);

    Fuko::Internal::FastIntersectAxisAlignedBoxPlane(vCenter, vExtents, Plane4, Outside, Inside);
    AnyOutside = XMVectorOrInt(AnyOutside, Outside);
    AllInside = XMVectorAndInt(AllInside, Inside);

    Fuko::Internal::FastIntersectAxisAlignedBoxPlane(vCenter, vExtents, Plane5, Outside, Inside);
    AnyOutside = XMVectorOrInt(AnyOutside, Outside);
    AllInside = XMVectorAndInt(AllInside, Inside);
...
inline ContainmentType BoundingOrientedBox::Contains(const BoundingOrientedBox& box) const noexcept
{
    ...
    assert(Fuko::Internal::XMQuaternionIsUnit(aOrientation));
    ...
    assert(Fuko::Internal::XMQuaternionIsUnit(bOrientation));
...
inline bool BoundingOrientedBox::Intersects(const BoundingOrientedBox& box) const noexcept
{
    ...
    assert(Fuko::Internal::XMQuaternionIsUnit(A_quat));
    assert(Fuko::Internal::XMQuaternionIsUnit(B_quat));
...
inline PlaneIntersectionType XM_CALLCONV BoundingOrientedBox::Intersects(FXMVECTOR Plane) const noexcept
{
    ...
    XMVECTOR Outside, Inside;
    Fuko::Internal::FastIntersectOrientedBoxPlane(vCenter, vExtents, R.r[0], R.r[1], R.r[2], Plane, Outside, Inside);
    ...
    HXMVECTOR Plane4, HXMVECTOR Plane5) const noexcept
{
    ...
    // Test against each plane.
    Fuko::Internal::FastIntersectOrientedBoxPlane(vCenter, vExtents, R.r[0], R.r[1], R.r[2], Plane0, Outside, Inside);

    XMVECTOR AnyOutside = Outside;
    XMVECTOR AllInside = Inside;

    Fuko::Internal::FastIntersectOrientedBoxPlane(vCenter, vExtents, R.r[0], R.r[1], R.r[2], Plane1, Outside, Inside);
    AnyOutside = XMVectorOrInt(AnyOutside, Outside);
    AllInside = XMVectorAndInt(AllInside, Inside);

    Fuko::Internal::FastIntersectOrientedBoxPlane(vCenter, vExtents, R.r[0], R.r[1], R.r[2], Plane2, Outside, Inside);
    AnyOutside = XMVectorOrInt(AnyOutside, Outside);
    AllInside = XMVectorAndInt(AllInside, Inside);

    Fuko::Internal::FastIntersectOrientedBoxPlane(vCenter, vExtents, R.r[0], R.r[1], R.r[2], Plane3, Outside, Inside);
    AnyOutside = XMVectorOrInt(AnyOutside, Outside);
    AllInside = XMVectorAndInt(AllInside, Inside);

    Fuko::Internal::FastIntersectOrientedBoxPlane(vCenter, vExtents, R.r[0], R.r[1], R.r[2], Plane4, Outside, Inside);
    AnyOutside = XMVectorOrInt(AnyOutside, Outside);
    AllInside = XMVectorAndInt(AllInside, Inside);

    Fuko::Internal::FastIntersectOrientedBoxPlane(vCenter, vExtents, R.r[0], R.r[1], R.r[2], Plane5, Outside, Inside);
    AnyOutside = XMVectorOrInt(AnyOutside, Outside);
    AllInside = XMVectorAndInt(AllInside, Inside);
...
inline void BoundingOrientedBox::CreateFromPoints(BoundingOrientedBox& Out, size_t Count, const XMFLOAT3* pPoints, size_t Stride) noexcept
{
    ...
    Fuko::Internal::CalculateEigenVectorsFromCovarianceMatrix(XMVectorGetX(XX_YY_ZZ), XMVectorGetY(XX_YY_ZZ),
...
inline bool BoundingFrustum::Intersects(const BoundingSphere& sh) const noexcept
{
    ...
    for (size_t i = 0; i < 12; ++i)
    {
        ...
        XMVECTOR Point = Fuko::Internal::PointOnLineSegmentNearestPoint(Corners[ei0], Corners[ei1], vCenter);
...
inline bool BoundingFrustum::Intersects(const BoundingOrientedBox& box) const noexcept
{
    ...
    assert(Fuko::Internal::XMQuaternionIsUnit(FrustumOrientation));
    ...
    // Test against box axes (3)
    {
        ...
        if (Fuko::Internal::XMVector3AnyTrue(Result))
            return false;
    }
...
inline bool BoundingFrustum::Intersects(const BoundingFrustum& fr) const noexcept
{
    ...
    assert(Fuko::Internal::XMQuaternionIsUnit(OrientationB));
    ...
    assert(Fuko::Internal::XMQuaternionIsUnit(OrientationA));
...
inline PlaneIntersectionType XM_CALLCONV BoundingFrustum::Intersects(FXMVECTOR Plane) const noexcept
{
    ...
    XMVECTOR Outside, Inside;
    Fuko::Internal::FastIntersectFrustumPlane(Corners0, Corners1, Corners2, Corners3,
...
inline bool XM_CALLCONV BoundingFrustum::Intersects(FXMVECTOR rayOrigin, FXMVECTOR Direction, float& Dist) const noexcept
{
    ...
    for (size_t i = 0; i < 6; ++i)
    {
        XMVECTOR Plane = Fuko::Internal::XMPlaneTransform(Planes[i], frOrientation, frOrigin);
    ...
    XMVECTOR* LeftPlane, XMVECTOR* TopPlane, XMVECTOR* BottomPlane) const noexcept
{
    ...
    if (NearPlane)
    {
        ...
        vNearPlane = Fuko::Internal::XMPlaneTransform(vNearPlane, vOrientation, vOrigin);
    ...
    if (FarPlane)
    {
        ...
        vFarPlane = Fuko::Internal::XMPlaneTransform(vFarPlane, vOrientation, vOrigin);
    ...
    if (RightPlane)
    {
        ...
        vRightPlane = Fuko::Internal::XMPlaneTransform(vRightPlane, vOrientation, vOrigin);
    ...
    if (LeftPlane)
    {
        ...
        vLeftPlane = Fuko::Internal::XMPlaneTransform(vLeftPlane, vOrientation, vOrigin);
    ...
    if (TopPlane)
    {
        ...
        vTopPlane = Fuko::Internal::XMPlaneTransform(vTopPlane, vOrientation, vOrigin);
    ...
    if (BottomPlane)
    {
        ...
        vBottomPlane = Fuko::Internal::XMPlaneTransform(vBottomPlane, vOrientation, vOrigin);
...
namespace TriangleTests
{
        ...
        inline bool XM_CALLCONV Intersects(FXMVECTOR A0, FXMVECTOR A1, FXMVECTOR A2, GXMVECTOR B0, HXMVECTOR B1, HXMVECTOR B2) noexcept
    {
        ...
        if (Fuko::Internal::XMVector3AllTrue(XMVectorSelect(ADistIsGreaterEqual, ADistIsLess, Select0111)) ||
            Fuko::Internal::XMVector3AllTrue(XMVectorSelect(ADistIsGreater, ADistIsLessEqual, Select0111)))
        {
            // A0 is singular, crossing from positive to negative.
            AA0 = A0; AA1 = A1; AA2 = A2;
            bPositiveA = true;
        }
        else if (Fuko::Internal::XMVector3AllTrue(XMVectorSelect(ADistIsLessEqual, ADistIsGreater, Select0111)) ||
            Fuko::Internal::XMVector3AllTrue(XMVectorSelect(ADistIsLess, ADistIsGreaterEqual, Select0111)))
        {
            // A0 is singular, crossing from negative to positive.
            AA0 = A0; AA1 = A2; AA2 = A1;
            bPositiveA = false;
        }
        else if (Fuko::Internal::XMVector3AllTrue(XMVectorSelect(ADistIsGreaterEqual, ADistIsLess, Select1011)) ||
            Fuko::Internal::XMVector3AllTrue(XMVectorSelect(ADistIsGreater, ADistIsLessEqual, Select1011)))
        {
            // A1 is singular, crossing from positive to negative.
            AA0 = A1; AA1 = A2; AA2 = A0;
            bPositiveA = true;
        }
        else if (Fuko::Internal::XMVector3AllTrue(XMVectorSelect(ADistIsLessEqual, ADistIsGreater, Select1011)) ||
            Fuko::Internal::XMVector3AllTrue(XMVectorSelect(ADistIsLess, ADistIsGreaterEqual, Select1011)))
        {
            // A1 is singular, crossing from negative to positive.
            AA0 = A1; AA1 = A0; AA2 = A2;
            bPositiveA = false;
        }
        else if (Fuko::Internal::XMVector3AllTrue(XMVectorSelect(ADistIsGreaterEqual, ADistIsLess, Select1101)) ||
            Fuko::Internal::XMVector3AllTrue(XMVectorSelect(ADistIsGreater, ADistIsLessEqual, Select1101)))
        {
            // A2 is singular, crossing from positive to negative.
            AA0 = A2; AA1 = A0; AA2 = A1;
            bPositiveA = true;
        }
        else if (Fuko::Internal::XMVector3AllTrue(XMVectorSelect(ADistIsLessEqual, ADistIsGreater, Select1101)) ||
            Fuko::Internal::XMVector3AllTrue(XMVectorSelect(ADistIsLess, ADistIsGreaterEqual, Select1101)))
        {
        ...
        if (Fuko::Internal::XMVector3AllTrue(XMVectorSelect(BDistIsGreaterEqual, BDistIsLess, Select0111)) ||
            Fuko::Internal::XMVector3AllTrue(XMVectorSelect(BDistIsGreater, BDistIsLessEqual, Select0111)))
        {
            // B0 is singular, crossing from positive to negative.
            BB0 = B0; BB1 = B1; BB2 = B2;
            bPositiveB = true;
        }
        else if (Fuko::Internal::XMVector3AllTrue(XMVectorSelect(BDistIsLessEqual, BDistIsGreater, Select0111)) ||
            Fuko::Internal::XMVector3AllTrue(XMVectorSelect(BDistIsLess, BDistIsGreaterEqual, Select0111)))
        {
            // B0 is singular, crossing from negative to positive.
            BB0 = B0; BB1 = B2; BB2 = B1;
            bPositiveB = false;
        }
        else if (Fuko::Internal::XMVector3AllTrue(XMVectorSelect(BDistIsGreaterEqual, BDistIsLess, Select1011)) ||
            Fuko::Internal::XMVector3AllTrue(XMVectorSelect(BDistIsGreater, BDistIsLessEqual, Select1011)))
        {
            // B1 is singular, crossing from positive to negative.
            BB0 = B1; BB1 = B2; BB2 = B0;
            bPositiveB = true;
        }
        else if (Fuko::Internal::XMVector3AllTrue(XMVectorSelect(BDistIsLessEqual, BDistIsGreater, Select1011)) ||
            Fuko::Internal::XMVector3AllTrue(XMVectorSelect(BDistIsLess, BDistIsGreaterEqual, Select1011)))
        {
            // B1 is singular, crossing from negative to positive.
            BB0 = B1; BB1 = B0; BB2 = B2;
            bPositiveB = false;
        }
        else if (Fuko::Internal::XMVector3AllTrue(XMVectorSelect(BDistIsGreaterEqual, BDistIsLess, Select1101)) ||
            Fuko::Internal::XMVector3AllTrue(XMVectorSelect(BDistIsGreater, BDistIsLessEqual, Select1101)))
        {
            // B2 is singular, crossing from positive to negative.
            BB0 = B2; BB1 = B0; BB2 = B1;
            bPositiveB = true;
        }
        else if (Fuko::Internal::XMVector3AllTrue(XMVectorSelect(BDistIsLessEqual, BDistIsGreater, Select1101)) ||
            Fuko::Internal::XMVector3AllTrue(XMVectorSelect(BDistIsLess, BDistIsGreaterEqual, Select1101)))
        {
        ...
        inline PlaneIntersectionType XM_CALLCONV Intersects(FXMVECTOR V0, FXMVECTOR V1, FXMVECTOR V2, GXMVECTOR Plane) noexcept
    {
        ...
        XMVECTOR Outside, Inside;
        Fuko::Internal::FastIntersectTrianglePlane(TV0, TV1, TV2, Plane, Outside, Inside);
            ...
            CXMVECTOR Plane3, CXMVECTOR Plane4, CXMVECTOR Plane5) noexcept
    {
        ...
        // Test against each plane.
        Fuko::Internal::FastIntersectTrianglePlane(TV0, TV1, TV2, Plane0, Outside, Inside);

        XMVECTOR AnyOutside = Outside;
        XMVECTOR AllInside = Inside;

        Fuko::Internal::FastIntersectTrianglePlane(TV0, TV1, TV2, Plane1, Outside, Inside);
        AnyOutside = XMVectorOrInt(AnyOutside, Outside);
        AllInside = XMVectorAndInt(AllInside, Inside);

        Fuko::Internal::FastIntersectTrianglePlane(TV0, TV1, TV2, Plane2, Outside, Inside);
        AnyOutside = XMVectorOrInt(AnyOutside, Outside);
        AllInside = XMVectorAndInt(AllInside, Inside);

        Fuko::Internal::FastIntersectTrianglePlane(TV0, TV1, TV2, Plane3, Outside, Inside);
        AnyOutside = XMVectorOrInt(AnyOutside, Outside);
        AllInside = XMVectorAndInt(AllInside, Inside);

        Fuko::Internal::FastIntersectTrianglePlane(TV0, TV1, TV2, Plane4, Outside, Inside);
        AnyOutside = XMVectorOrInt(AnyOutside, Outside);
        AllInside = XMVectorAndInt(AllInside, Inside);

        Fuko::Internal::FastIntersectTrianglePlane(TV0, TV1, TV2, Plane5, Outside, Inside);
        AnyOutside = XMVectorOrInt(AnyOutside, Outside);
        AllInside = XMVectorAndInt(AllInside, Inside);
