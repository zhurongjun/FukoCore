...
#define BYTESWAP_INTRINSIC_PRIVATE_16(Val) _byteswap_ushort(Val);
#define BYTESWAP_INTRINSIC_PRIVATE_32(Val) _byteswap_ulong(Val);
#define BYTESWAP_INTRINSIC_PRIVATE_64(Val) _byteswap_uint64(Val);

static FORCEINLINE uint16 BYTESWAP_ORDER16(uint16 Val)
{
#if defined(BYTESWAP_INTRINSIC_PRIVATE_16)
	return BYTESWAP_INTRINSIC_PRIVATE_16(Val);
#else
...
{
#if defined(BYTESWAP_INTRINSIC_PRIVATE_32)
	return BYTESWAP_INTRINSIC_PRIVATE_32(Val);
#else
...
{
#if defined(BYTESWAP_INTRINSIC_PRIVATE_64)
	return BYTESWAP_INTRINSIC_PRIVATE_64(Value);
#else
